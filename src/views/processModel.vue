...
export default {
  ...
  mounted () {
    ...
    return Promise.all(promises).then((resultsArr) => {
      ...
      //this.collectAndDrawClasses({name: 'interface', id: '111'}, new THREE.Vector3(0, 0, 0))
      let obj = new classObject3d(this.geometry, this.interfaceMaterial, new THREE.Vector3(0, 0, 0), {name: 'interface', id: '111'}, this.font)
      this.modelObject3D.add(obj)
